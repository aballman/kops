...
func (c *keysets) Get(name string, options v1.GetOptions) (result *v1alpha2.Keyset, err error) {
...
func (c *keysets) Create(keyset *v1alpha2.Keyset) (result *v1alpha2.Keyset, err error) {
	result = &v1alpha2.Keyset{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("keysets").
...
func (c *keysets) Update(keyset *v1alpha2.Keyset) (result *v1alpha2.Keyset, err error) {
	result = &v1alpha2.Keyset{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("keysets").
...
func (c *keysets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Keyset, err error) {
	result = &v1alpha2.Keyset{}
